...
$query=mysqli_query($con,"select id_usuario from usuario where id_usuario='$eid'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update usuario set password='$nueva_password' where id_usuario='$eid'");
$msg= "La contraseña del usuario ha sido cambiada exitosamente"; 
} else {
...
<head>
    ...
    <title>DataTech | Restablecer Contraseña</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="admin_contra.php">Cambiar contraseña</a></li>
