         ...
         <div class="col-sm-6 col-lg-6">
                <div class="card text-white bg-flat-color-4">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton4">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="anomalia_empleado.php">Ver</a>
                        ...
                        $query=mysqli_query($con,"Select * from anomalia where id_usuario='$data_tech'");
                    ...
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="ultimo_registro.php">Ver</a>
                        ...
                        <?php 
                         $data_tech=$_SESSION['datatechnologyid'];
                        $query1=mysqli_query($con,"Select * from  bitacora where id_usuario='$data_tech'");
$totalcomp=mysqli_num_rows($query1);
?>
                        <h4 class="mb-0">
                            <span class="count"><?php echo $totalcomp;?></span>
                        </h4>
                        <p class="text-light">Ultimos registros</p>
