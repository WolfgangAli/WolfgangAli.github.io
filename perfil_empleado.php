...
if (strlen($_SESSION['datatechnologyid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    if ($query) {
    $msg="El perfil del empleado ha sido actualizado.";
  }
  else
    {
...
<head>
    ...
    <title>DataTech | Perfil del Empleado</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="perfil_empleado.php">Perfil del empleado</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>Empleado</strong><small> Perfil</small></div>
...
?>
                                ...
                                <div class="form-group"><label for="company" class=" form-control-label">Nombre del empleado</label><input type="text" name="nombre" value="<?php  echo $row['nombre'];?>" class="form-control" required='true'></div>
                                    <div class="form-group"><label for="vat" class=" form-control-label">Usuario del empleado</label><input type="text" name="nombre_usuario" value="<?php  echo $row['nombre_usuario'];?>" class="form-control" readonly=""></div>
